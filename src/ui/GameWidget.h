...
protected:
    ...
    QLabel* m_typeWriterLabel = nullptr;      // Для текста с эффектом печати
    QPushButton* m_notesButton = nullptr;     // Кнопка записок
    QPushButton* m_exitButton = nullptr;      // Кнопка выхода
