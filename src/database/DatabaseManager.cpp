...
bool DatabaseManager::shouldReinitialize()
{
    ...
    QFileInfo sqlFileInfo("game_database.sql");
    QFileInfo dbFileInfo("maze_game.db");
...
bool DatabaseManager::connect()
{
    ...
    QDir sqlDir(baseDir);
    sqlDir.cd("..");          // -> src
    sqlDir.cd("database");    // -> src/database
    QString sqlPath = sqlDir.filePath("game_database.sql");
